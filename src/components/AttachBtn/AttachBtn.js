...
export default class AttachBtn extends Component {
  render() {
    return (
      <button className="attachBtn" onClick={this.props.handleClickAttach}>
        <svg
          width="17"
          height="15"
          viewBox="0 0 17 15"
        ...
        <span className="attachBtn_text">Прикрепить файл</span>
      </button>
    );
  }
}
